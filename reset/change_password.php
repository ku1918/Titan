        ...
        <form method="post" autocomplete="off" id="password_form">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-sm-10">
                ...
                <input type="password" id="passwords" name="password"  class="form-control required" onchange="form.confirmPassword.pattern = this.value;">
              </div>
            </div>
          </div>
          <div class="form-group">
          <div class="row">
            <div class="col-sm-10">
              ...
              <input type="password" id="cpassword" name="cpassword" title="Password is mismatch" class="form-control required" value="">
            </div>
          </div>
          </div>         
          </div>
